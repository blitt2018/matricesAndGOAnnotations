...
#set output file
output_file("GO_dist_freqs_pos.html")

#create figure 
p = figure(title="Distance of New GOs to BLOSUM62 GOs")

#set axis labels
p.xaxis.axis_label = "closest distance between new matrix annotation and B62 annotation"
        ...
        if query in GO_dict["BLOSUM62.out"].keys(): 
            if GOs: 
                for GO in GOs: 
                    ...
                    if distance_options: 
                        closest_GO_dist = min(distance_options)
